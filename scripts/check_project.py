...
def main() -> None:
    required = [
        ...
        ROOT / "frontend" / "assets" / "vendor" / "mediapipe" / "hands" / "hands.js",
        ROOT / "frontend" / "assets" / "vendor" / "mediapipe" / "hands" / "hands_solution_packed_assets.data",
        ROOT / "frontend" / "assets" / "vendor" / "mediapipe" / "hands" / "hands_solution_simd_wasm_bin.wasm",
        ROOT / "frontend" / "assets" / "vendor" / "mediapipe" / "hands" / "hand_landmark_lite.tflite",
        ROOT / "frontend" / "control.html",
        ROOT / "frontend" / "navigation.html",
        ROOT / "frontend" / "cruise.html",
